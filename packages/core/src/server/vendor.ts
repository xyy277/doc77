...
export const VENDOR_ASSETS: VendorAsset[] = [
  ...
  { name: 'mermaid.min.js', url: 'https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js', type: 'js', size: '~2MB' },
  { name: 'highlight.min.js', url: 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js', type: 'js', size: '~500KB' },
  { name: 'highlight-github-dark.css', url: 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github-dark.min.css', type: 'css', size: '~10KB' },
  { name: 'pdf.min.mjs', url: 'https://cdn.jsdelivr.net/npm/pdfjs-dist@4.10.38/build/pdf.min.mjs', type: 'js', size: '~350KB' },
  { name: 'pdf.worker.min.mjs', url: 'https://cdn.jsdelivr.net/npm/pdfjs-dist@4.10.38/build/pdf.worker.min.mjs', type: 'js', size: '~1.4MB' },
  { name: 'xlsx.mini.min.js', url: 'https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.mini.min.js', type: 'js', size: '~150KB' },
  { name: 'mammoth.browser.min.js', url: 'https://cdn.jsdelivr.net/npm/mammoth@1.8.0/mammoth.browser.min.js', type: 'js', size: '~160KB' },
  { name: 'pyodide.js', url: 'https://cdn.jsdelivr.net/pyodide/v0.27.5/full/pyodide.js', type: 'js', size: '~600KB' },
  { name: 'pyodide-pyodide.asm.wasm', url: 'https://cdn.jsdelivr.net/pyodide/v0.27.5/full/pyodide.asm.wasm', type: 'wasm', size: '~9MB' },
  { name: 'pyodide-python_stdlib.zip', url: 'https://cdn.jsdelivr.net/pyodide/v0.27.5/full/python_stdlib.zip', type: 'wasm', size: '~2MB' },
];
